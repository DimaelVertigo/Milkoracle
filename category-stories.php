...
<ul class="row m-15">
    ...
    <?php 
    echo do_shortcode('[ajax_load_more category="show-college-life-on-strories,show-career-on-stories,show-admission-on-stories,trending-stories" category__not_in="61"  posts_per_page="6" transition="fade"]');
    ?>
</main><!-- #main -->
</div>
<?php get_footer(); ?>
