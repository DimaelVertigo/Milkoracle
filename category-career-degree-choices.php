...
<main>
    <div class="row"><h1>Career & Degree Choices</h1>
    </div>
...
<ul class="row m-15 m-15">
    ...
    query_posts('posts_per_page=3&orderby=comment_count&order=DESC&cat=-64,65');
    ...
    <?php 
    echo do_shortcode('[ajax_load_more category="show-college-life-on-career,show-stories-on-career,show-admission-on-career,featured-career-articles" category__not_in="64"  posts_per_page="6" transition="fade"]');
    ?>
</main><!-- #main -->
</div>
<?php get_footer(); ?>
