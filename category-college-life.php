...
<main>
    <div class="row"><h1>College life</h1>
    </div>
    ...
    <div class="featured">
        ...
        <div class="row">
            <?php query_posts('showposts=1&cat=57'); ?>
...
<ul class="row m-15">
    ...
    query_posts('posts_per_page=3&orderby=comment_count&order=DESC&cat=-57,58');
    ...
    <?php 
    echo do_shortcode('[ajax_load_more category="show-admission-on-college-life,show-career-on-college-life,show-stories-on-college-life,trending-college" category__not_in="57"  posts_per_page="6" transition="fade"]');
    ?>
</main><!-- #main -->
</div>
<?php get_footer(); ?>
