...
<main>
    ...
    <div class="featured">
        ...
        <div class="row">
            <?php query_posts('showposts=1&post_type=career&cat=64'); ?>
...
<ul class="row m-15">
    ...
    query_posts('post_type=career&posts_per_page=3&orderby=comment_count&order=DESC&cat=-64');
    ...
    <ul class="row">
    <?php $additional_loop = new WP_Query("post_type=career&cat=65&paged=$paged"); ?>
