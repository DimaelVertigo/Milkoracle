...
<main>
    ...
    <div class="featured">
        ...
        <div class="row">
            <?php query_posts('showposts=1&post_type=admission&cat=67'); ?>
...
<ul class="row m-15">
    ...
    query_posts('post_type=admission&posts_per_page=3&orderby=comment_count&order=DESC&cat=-67');
    ...
    <ul class="row">
    <?php $additional_loop = new WP_Query("post_type=admission&cat=68&paged=$paged"); ?>
